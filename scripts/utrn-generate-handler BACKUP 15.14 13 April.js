console.log("✅ Active version: utrn-generate-handler.js (Updated 13 April 13:40)");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  executeButton.addEventListener("click", () => {
    ...
    const newEntry = {
      ...
      appliedTime: null,
      reason: reason // capture dropdown selection
    };
    ...
    // Apply UTRN after delay
    const delay = Math.floor(20000 + Math.random() * 77000); // 20s–97s
    setTimeout(() => {
